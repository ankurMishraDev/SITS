...
export function AddAdvanceModal({ visible, onClose, tripId, side }: AddAdvanceModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert('Error', error.message || 'Failed to add advance');
    }
  };
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.modalContent}>
          <Text style={styles.title}>Add Advance ({side === 'party' ? 'Party' : 'Supplier'})</Text>
